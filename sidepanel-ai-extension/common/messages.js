...
(function initMessageTypes(global) {
  ...
  const MSG = (global.MessageTypes && global.MessageTypes.MSG) || {
    ...
    // DOM Actions
    DOM_ACTION_NAVIGATE: "navigate",
    DOM_ACTION_CLICK: "click",
    DOM_ACTION_FILL: "fill",
    DOM_ACTION_SCROLL: "scroll",
    DOM_ACTION_WAIT_FOR_SELECTOR: "waitForSelector",
    DOM_ACTION_SCREENSHOT: "screenshot",
    DOM_ACTION_TABS_QUERY: "tabs.query",
    DOM_ACTION_TABS_ACTIVATE: "tabs.activate",
    DOM_ACTION_TABS_CLOSE: "tabs.close",
    DOM_ACTION_DONE: "done"
  };
