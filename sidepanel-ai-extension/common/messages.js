...
(function initMessageTypes(global) {
  ...
  const MSG = (global.MessageTypes && global.MessageTypes.MSG) || {
    ...
    CHAT_DIRECT: "CHAT_DIRECT", // Fast chat without page context
    ...
    AGENT_STATUS_UPDATE: "AGENT_STATUS_UPDATE", // Fine-grained status updates
    AGENT_PLAN_GENERATED: "AGENT_PLAN_GENERATED",
    AGENT_STEP_UPDATE: "AGENT_STEP_UPDATE",
    AGENT_FINISHED: "AGENT_FINISHED",
    SHOW_REPORT: "SHOW_REPORT",
    CHAT_MESSAGE: "CHAT_MESSAGE",
    COORDINATE_AND_EXECUTE: "COORDINATE_AND_EXECUTE",
    ...
    AGENT_SCREENSHOT_READY: "AGENT_SCREENSHOT_READY",
    ...
    // Debug overlay (visualize interactables and click by index)
